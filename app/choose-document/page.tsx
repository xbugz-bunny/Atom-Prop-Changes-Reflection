...
export default function ChooseDocumentPage() {
    return (
        <div className="min-h-screen bg-white font-outfit relative overflow-hidden">
            ...
            <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16 py-8 relative z-10">
                ...
                <div className="max-w-7xl">
                    <div className="mb-12">
                        <h1 className="text-[52px] font-bold text-zinc-900 mb-4 tracking-tight leading-tight">Choose Your Document</h1>
                        <p className="text-zinc-800 text-2xl font-medium">select issuing country to see which document we accept</p>
                    </div>

                    <form className="space-y-10">
                        {/* Issuing Country Dropdown */}
                        <div className="space-y-3 max-w-md">
                            <label className="text-zinc-500 text-lg font-medium block">Issuing Country</label>
                        ...
                        {/* Accepted Documents */}
                        <div className="space-y-3 max-w-md">
                            <label className="text-zinc-500 text-lg font-medium block">Accepted documents</label>
                            <Link href="/upload-doc-final">
                                <div className="px-6 py-4 bg-zinc-50 border border-zinc-100 rounded-2xl flex items-center justify-between cursor-pointer hover:bg-zinc-100 transition-colors group">
                                    <span className="text-zinc-900 text-lg font-medium">CNIC</span>
                                    <div className="w-6 h-6 rounded-full border-2 border-zinc-300 flex items-center justify-center group-hover:border-blue-500 transition-colors">
