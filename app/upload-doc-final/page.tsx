...
export default function UploadDocFinalPage() {
    return (
            ...
            <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16 py-8 relative z-10">
                ...
                <div className="flex flex-col gap-8 mb-12">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        >
                            ...
                            <span className="text-xl font-bold">Choose Your Documents</span>
                        </Link>
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="bg-white rounded-[32px] border border-zinc-50 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] p-10 relative">
                        {/* Inner Back Arrow */}
                        <Link href="/choose-document" className="absolute left-8 top-10 text-[#2e62af] hover:opacity-70 transition-opacity">
                        ...
                        <div className="text-center mb-8">
                            <h1 className="text-4xl font-bold text-zinc-900 mb-2">Choose Your Document</h1>
                            <p className="text-zinc-700 text-xl font-medium italic">scans and photocopies are not accepted</p>
                        </div>

                        {/* Guidelines Grid (Using the provided image) */}
                        <div className="relative w-full aspect-[4/3] max-w-2xl mx-auto mb-10">
                            <Image
                                src="/images/doc-examples.png"
                        ...
                        {/* Bottom gradient button inside or outside? Looking at design it seems outside at bottom center */}
                    </div>

                    {/* Continue Button */}
                    <div className="mt-12 flex justify-center">
                        <Link href="/passport-photo-page">
                            <button
                                className="w-[300px] py-[18px] px-10 bg-gradient-to-r from-[#2e62af] to-[#912d90] text-white rounded-full font-bold text-xl hover:shadow-[0_10px_30px_rgba(145,45,144,0.3)] transition-all flex items-center justify-center gap-3 group"
                            >
